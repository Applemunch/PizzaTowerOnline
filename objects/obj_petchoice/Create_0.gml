...
selarray = [
	...
	[spr_petcaptions_idle, "CAPTIONS", "Please don't use this while playing as Glade I beg you -peic\nPlease don't use this -loypoll"],
	...
	[spr_petmisty_idle, "MISTY", "Please don't eat him."],
];
