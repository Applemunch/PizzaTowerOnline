...
prompt_array[1] = tv_create_prompt("PTV isnt really sure what the countdown means, why the ground is shaking or why people are screaming.", true, spr_tv_idleanim2, 3);